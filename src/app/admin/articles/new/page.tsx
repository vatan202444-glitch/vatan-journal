...
export default function NewArticle() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Мақолани сақлашда хатолik yuz berdi');
    } finally {
      setLoading(false);
    }
  };
    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-[#1e293b] font-serif">Янги мақола</h1>
            <p className="text-[#64748b] mt-1">Янги мақола қўшиш</p>
          </div>
          <Link
            href="/admin/articles"
